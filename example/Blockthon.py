...
from blockthon.blockthon import Wallet
from blockthon.symbols import BTC, ETH, TRX, LTC, DOGE, DGB, RVN, DASH, BTG, VIA, QTUM, ZEC
...
def P2PKH_From_PrivateKey(privatekey):
    wallet: Wallet = Wallet(symbol=BTC)
...
def ETH_From_PrivateKey(privatekey):
    wallet: Wallet = Wallet(symbol=ETH)
    wallet.from_private_key(privatekey)
    return wallet.p2pkh_address()
...
def TRX_From_PrivateKey(privatekey):
    wallet: Wallet = Wallet(symbol=TRX)
    wallet.from_private_key(privatekey)
    return wallet.p2pkh_address()
...
def DOGE_From_PrivateKey(privatekey):
    wallet: Wallet = Wallet(symbol=DOGE)
    wallet.from_private_key(privatekey)
    return wallet.p2pkh_address()
...
def DASH_From_PrivateKey(privatekey):
    wallet: Wallet = Wallet(symbol=DASH)
    wallet.from_private_key(privatekey)
    return wallet.p2pkh_address()
...
def BTG_From_PrivateKey(privatekey):
    wallet: Wallet = Wallet(symbol=BTG)
    wallet.from_private_key(privatekey)
    return wallet.p2pkh_address()
...
def LTC_From_PrivateKey(privatekey):
    wallet: Wallet = Wallet(symbol=LTC)
    wallet.from_private_key(privatekey)
    return wallet.p2pkh_address()
...
def DigiByte_From_PrivateKey(privatekey):
    wallet: Wallet = Wallet(symbol=DGB)
    wallet.from_private_key(privatekey)
    return wallet.p2pkh_address()
...
def RVN_From_PrivateKey(privatekey):
    wallet: Wallet = Wallet(symbol=RVN)
    wallet.from_private_key(privatekey)
    return wallet.p2pkh_address()
...
def VIA_From_PrivateKey(privatekey):
    wallet: Wallet = Wallet(symbol=VIA)
    wallet.from_private_key(privatekey)
    return wallet.p2pkh_address()
...
def QTUM_From_PrivateKey(privatekey):
    wallet: Wallet = Wallet(symbol=QTUM)
    wallet.from_private_key(privatekey)
    return wallet.p2pkh_address()
...
def ZEC_From_PrivateKey(privatekey):
    wallet: Wallet = Wallet(symbol=ZEC)
    wallet.from_private_key(privatekey)
    return wallet.p2pkh_address()
